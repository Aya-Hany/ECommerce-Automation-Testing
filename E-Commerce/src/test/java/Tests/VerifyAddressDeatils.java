...
public class VerifyAddressDeatils  extends TestBase {
	HomePage home;
	CartPage Cart;
	NewAccount account;
	...
	public void  VerifyAdressDearils(String title,String name,String email,String password,String day,String month,String year,String FName,String LName,String Company,String Address,
        ...
        product.viewBtn.click();
         ...
         Assert.assertTrue(Cart.verifyAddressDetailsVisible(), "Address details not visible"); 
        ...
        Cart.clickDeleteAccount();
	     // Assert.assertTrue(Cart.verifyAccountDeleted());
