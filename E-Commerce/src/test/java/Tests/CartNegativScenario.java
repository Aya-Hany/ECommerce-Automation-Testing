...
public class CartNegativScenario extends TestBase {
	HomePage home;
	CartPage Cart;
	NewAccount account;
	productDetailsPage detail;
	RegisterPage Register;
	@DataProvider(name="createNData")
	public Object[][] getData() throws IOException{
		Properties p =LoadPropertiesData.creatNData;
		Object[][] data = {
	...
	public void testPlaceOrderRegisterWhileCheckout(String title,String name,String email,String password,String day,String month,String year,String FName,String LName,String Company,String Address,
      ...
      // Assert.assertTrue(account.createdMessage.isDisplayed(), "Account not created!");
       Assert.assertFalse( account.createdMessage.isDisplayed());
