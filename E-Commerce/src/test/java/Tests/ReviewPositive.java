...
public class ReviewPositive extends TestBase{
	HomePage home;
	ProductPage product;
	...
	Actions action;
	 @DataProvider(name="reviewData")
	  public Object[][] review(){
		 Properties p =LoadPropertiesData.validRewiewData;
		  Object[][] data= {
	...
	public void reviewCheck(String name,String email,String message){
	    ...
	    Assert.assertEquals("Thank you for your review.",details.reviewConfermMessage.getText());
