...
public class Downloadinvoice  extends TestBase {  
	...
	public void Downloadinvoice (String title,String name,String email,String password,String day,String month,String year,String FName,String LName,String Company,String Address,
